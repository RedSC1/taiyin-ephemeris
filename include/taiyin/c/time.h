...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_julian_day(
    const taiyin_calendar_datetime* datetime,
    double* out_jd
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_julian_day_split(
    const taiyin_calendar_datetime* datetime,
    taiyin_split_julian_date* out_jd
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_reverse_julian_day(
    double jd,
    taiyin_calendar_datetime* out_datetime
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_reverse_julian_day_split(
    const taiyin_split_julian_date* jd,
    taiyin_calendar_datetime* out_datetime
);
...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_add_seconds_to_split_jd(
    const taiyin_split_julian_date* jd,
    double seconds,
    taiyin_split_julian_date* out
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_seconds_between_split_jd(
...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_tai_minus_utc_seconds(
...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_utc_to_tai_split(
    const taiyin_split_julian_date* jd_utc,
    double tai_minus_utc_seconds,
    taiyin_split_julian_date* out_jd_tai
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_tai_to_tt_split(
    const taiyin_split_julian_date* jd_tai,
    taiyin_split_julian_date* out_jd_tt
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_utc_to_tt_split(
    const taiyin_split_julian_date* jd_utc,
    double tai_minus_utc_seconds,
    taiyin_split_julian_date* out_jd_tt
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_utc_to_ut1_split(
    const taiyin_split_julian_date* jd_utc,
    double dut1_seconds,
    taiyin_split_julian_date* out_jd_ut1
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_tt_to_ut1_split(
    const taiyin_split_julian_date* jd_tt,
    double delta_t_seconds,
    taiyin_split_julian_date* out_jd_ut1
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_ut1_to_tt_split(
    const taiyin_split_julian_date* jd_ut1,
    double delta_t_seconds,
    taiyin_split_julian_date* out_jd_tt
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_tt_to_tdb_split(
    const taiyin_split_julian_date* jd_tt,
    int32_t tdb_model_id,
    taiyin_split_julian_date* out_jd_tdb
);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_tdb_to_tt_split(
...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_make_time_scales_from_utc(
...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_make_estimated_time_scales_from_ut(
    const taiyin_calendar_datetime* datetime_ut,
    int32_t tdb_model_id,
    taiyin_estimated_time_scales* out
);
