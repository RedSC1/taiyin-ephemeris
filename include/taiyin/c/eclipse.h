...
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_lunar_eclipse_at_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_lunar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_lunar_eclipse_at_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_lunar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_lunar_eclipse_tt(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_lunar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_lunar_eclipse_ut(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_lunar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_lunar_eclipses_tt(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_lunar_eclipse_result_tt*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_lunar_eclipses_ut(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_lunar_eclipse_result_ut*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_lunar_eclipse_visibility_tt(const taiyin_context*, const taiyin_lunar_eclipse_result_tt*, uint64_t, taiyin_local_lunar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_lunar_eclipse_visibility_ut(const taiyin_context*, const taiyin_lunar_eclipse_result_ut*, uint64_t, taiyin_local_lunar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_local_lunar_eclipse_tt(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_local_lunar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_local_lunar_eclipse_ut(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_local_lunar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);

TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_solar_eclipse_at_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_solar_eclipse_at_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_solar_eclipse_tt(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_solar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_solar_eclipse_ut(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_solar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_solar_eclipses_tt(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_solar_eclipse_result_tt*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_solar_eclipses_ut(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_solar_eclipse_result_ut*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_local_solar_eclipse_at_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_local_solar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_solve_local_solar_eclipse_at_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_local_solar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_local_solar_eclipse_tt(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_local_solar_eclipse_result_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_search_next_local_solar_eclipse_ut(const taiyin_context*, const taiyin_split_julian_date*, uint32_t, uint64_t, taiyin_local_solar_eclipse_result_ut*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_solar_circumstances_tt(const taiyin_context*, const taiyin_split_julian_date*, taiyin_local_solar_eclipse_circumstances_tt*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_solar_circumstances_ut(const taiyin_context*, const taiyin_split_julian_date*, taiyin_local_solar_eclipse_circumstances_ut*, taiyin_ephemeris_diagnostic*);

TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_besselian_elements_tt(const taiyin_context*, const taiyin_split_julian_date*, double, taiyin_solar_besselian_elements*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_besselian_polynomial_tt(const taiyin_context*, const taiyin_split_julian_date*, double, double, int32_t, taiyin_solar_besselian_polynomial*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_evaluate_solar_besselian_polynomial(const taiyin_solar_besselian_polynomial*, double, taiyin_solar_besselian_elements*);

TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_row_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_route_row*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_row_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_route_row*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_where_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_where*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_where_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, taiyin_solar_eclipse_where*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_tt(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, double, uint64_t, taiyin_solar_eclipse_route_row*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_ut(const taiyin_context*, const taiyin_split_julian_date*, const taiyin_split_julian_date*, double, uint64_t, taiyin_solar_eclipse_route_row*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_curves_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_curve_point*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_curves_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_curve_point*, size_t, size_t*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_product_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_product_point*, size_t, size_t*, taiyin_solar_eclipse_route_product_summary*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_product_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_product_point*, size_t, size_t*, taiyin_solar_eclipse_route_product_summary*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_map_product_tt(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_product_point*, size_t, size_t*, taiyin_solar_eclipse_route_product_summary*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_solar_eclipse_route_map_product_ut(const taiyin_context*, const taiyin_split_julian_date*, uint64_t, size_t, taiyin_solar_eclipse_route_product_point*, size_t, size_t*, taiyin_solar_eclipse_route_product_summary*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_solar_eclipse_boundary_tt(const taiyin_context*, const taiyin_split_julian_date*, double, double, taiyin_local_solar_eclipse_boundary*, taiyin_ephemeris_diagnostic*);
TAIYIN_C_API taiyin_call_result TAIYIN_C_CALL taiyin_compute_local_solar_eclipse_boundary_ut(const taiyin_context*, const taiyin_split_julian_date*, double, double, taiyin_local_solar_eclipse_boundary*, taiyin_ephemeris_diagnostic*);
