...
RouteInflightAction RouteInflightMap::acquire(const EphemerisSegmentCacheKey& key) noexcept {
...
void RouteInflightMap::release(const EphemerisSegmentCacheKey& key, bool success) noexcept {
    {
...
RouteInflightGuard::RouteInflightGuard(RouteInflightMap& map, const EphemerisSegmentCacheKey& key) noexcept
