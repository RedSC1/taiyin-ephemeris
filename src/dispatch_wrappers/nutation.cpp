...
static bool iau2000b(const SplitJulianDate& jd_tt, const void* /*data*/, NutationAngles* out) {
    return iau2000b_nutation(jd_tt, out);
}

static bool iau2000a(const SplitJulianDate& jd_tt, const void* /*data*/, NutationAngles* out) {
