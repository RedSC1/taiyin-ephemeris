...
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_context_config_init(
    taiyin_bazi_context_config* value
);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_chart_init(taiyin_bazi_chart* value);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_relation_init(taiyin_bazi_relation* value);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_qiyun_result_init(
    taiyin_bazi_qiyun_result* value
);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_dayun_init(taiyin_bazi_dayun* value);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_xiaoyun_init(
    taiyin_bazi_xiaoyun* value
);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_renyuan_siling_segment_init(
    taiyin_bazi_renyuan_siling_segment* value
);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_renyuan_siling_result_init(
    taiyin_bazi_renyuan_siling_result* value
);

TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_context_create(
    const taiyin_bazi_context_config* bazi_config,
    taiyin_bazi_context** out_context
);
TAIYIN_C_API void TAIYIN_C_CALL taiyin_bazi_context_destroy(
    taiyin_bazi_context* context
);

TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_get_kong_wang(
    taiyin_ganzhi value,
    uint8_t out_branches[2]
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_get_ten_god(
    uint8_t day_stem_id,
    uint8_t target_stem_id,
    uint8_t* out_ten_god_id
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_get_hidden_stems(
    uint8_t branch_id,
    uint8_t out_stems[TAIYIN_BAZI_HIDDEN_STEM_CAPACITY],
    uint8_t* out_count
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_stem_relation(
    uint8_t stem_a,
    uint8_t stem_b,
    uint32_t* out_flags,
    uint8_t* out_combined_element_id
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_branch_relation(
    uint8_t branch_a,
    uint8_t branch_b,
    uint32_t* out_flags,
    uint8_t* out_combined_element_id
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_branch_triple_relation(
    uint8_t branch_a,
    uint8_t branch_b,
    uint8_t branch_c,
    uint32_t* out_flags,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_get_life_stage(
    uint8_t stem_id,
    uint8_t branch_id,
    int32_t earth_palace_mode,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_chart(
    const taiyin_bazi_context* context,
    const taiyin_ganzhi_four_pillars* pillars,
    taiyin_bazi_chart* out
);

TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_liunian(
    int32_t effective_year,
    taiyin_ganzhi* out
);
// month_branch is a Ganzhi branch ID: 2=Yin, ..., 0=Zi, 1=Chou.
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_liuyue(
    taiyin_ganzhi year_pillar,
    uint8_t month_branch,
    taiyin_ganzhi* out
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_liuri(
    const taiyin_calendar_datetime* civil_date,
    taiyin_ganzhi* out
);
// hour_index follows the branch sequence: 0=Zi, ..., 11=Hai.
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_liushi(
    taiyin_ganzhi day_pillar,
    uint8_t hour_index,
    taiyin_ganzhi* out
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_xiaoyun(
    const taiyin_bazi_chart* chart,
    int32_t direction,
    int32_t age,
    taiyin_ganzhi* out
);
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_fill_xiaoyun(
    const taiyin_bazi_chart* chart,
    int32_t direction,
    int32_t start_age,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_collect_chart_relations(
    const taiyin_bazi_chart* chart,
    uint32_t pillar_mask,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_collect_target_shen_sha(
    const taiyin_bazi_chart* chart,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_qiyun(
    const taiyin_bazi_context* context,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_fill_dayun(
    const taiyin_bazi_context* context,
    const taiyin_calendar_datetime* birth_civil_time,
    const taiyin_bazi_chart* chart,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_get_renyuan_siling_segments(
    uint8_t month_branch_id,
    int32_t table_model,
...
TAIYIN_C_API taiyin_status TAIYIN_C_CALL taiyin_bazi_calc_renyuan_siling(
    const taiyin_chinese_calendar_context* calendar_context,
