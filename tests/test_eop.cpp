...
bool interpolate_earth_orientation(
    const taiyin::internal::EarthOrientationTable* table,
    double jd_utc,
    taiyin::internal::EarthOrientationSample* out
) {
    return taiyin::internal::interpolate_earth_orientation(
        table, split_jd(jd_utc), out);
}

bool derive_earth_orientation_rates(
    const taiyin::internal::EarthOrientationTable* table,
    double jd_utc,
    taiyin::internal::EarthOrientationRates* rates,
    taiyin::internal::EarthRotationDerivatives* derivatives
) {
    return taiyin::internal::derive_earth_orientation_rates(
        table, split_jd(jd_utc), rates, derivatives);
}
