...
void test_self_deflection_skip() {
    ...
    if (!split_julian_date_from_double(2451545.0, &jd_tdb)) {
        std::fprintf(stderr, "FAIL: split apparent self-skip epoch\n");
        return;
    }
    const SplitJulianDate jd_tt = jd_tdb;
    ...
    bool sun_result = calc_apparent_batch(
        jd_tdb,
        jd_tt,
        1,
    ...
    bool jupiter_result = calc_apparent_batch(
        jd_tdb,
        jd_tt,
        1,
    ...
    bool sun_no_self_result = calc_apparent_batch(
        jd_tdb,
        jd_tt,
        1,
        &deflector_ids[0],
    ...
    bool jupiter_no_self_result = calc_apparent_batch(
        jd_tdb,
        jd_tt,
        1,
        &deflector_ids[1],
